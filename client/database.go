...
func dbMessageAdd(m *models.Message, bucket string) (int, error) {
	var msgID int
	if db == nil {
		return 0, nil
	}
...
func dbMessageGetByID(id int, username string) (models.Message, error) {
...
func dbMessageSuccess(id int, username string) error {
